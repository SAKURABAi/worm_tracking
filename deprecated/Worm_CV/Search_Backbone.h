...
#define BACKBONE_ALTER_RANGE  0.07
...
public:
	explicit Search_Backbone() :backbone(ROOT_SMOOTH::PARTITION_NUM + 1), 
	tempBackbone(ROOT_SMOOTH::PARTITION_NUM + 1),first_pic(true), worm_full_width(WORM::INF){
		lengthErrorCount = 0;
		frameCount = 0;
		meanWormLength = 0;
